module.exports = function(err, body, res){
  ...
  var code = /[0-9]/.test(''+err) ? err : (body && body.ResultCode && body.ResultCode) || false
  ...
  if(code && code != '000000')
    return {
      code: code,
      message: module.exports.codes[code] || 'Unknow error code'
    }
  
  if(res.statusCode != 200)
    return err || body || { stausCode: res.statusCode }
}
